        ...
        form.forEach(card => {
            if (forms.includes(card.id)) {
                ...
                <div class="card-body">
                  ...
                  <a href="#" class="btn btn-primary llenar"  data-id="${card.id}">Go somewhere</a>
                </div>
              </div>
